...
export default function profile() {
  ...
  const fetchData = async () => {
    try {
      ...
      if (!response.ok)  throw new Error(data.message || 'Failed to fetch user books1');
  ...
  const confirmDelete = (bookId) => {
    Alert.alert("delete recomendation", "are you sure want to delete this recommendation?", [
  ...
  const renderBookItem = ({item}) => (
    <View style={styles.bookItem}>
      ...
      <View style={styles.bookInfo}>
        ...
        <View style={styles.ratingContainer}>{renderRatingStarts(item.rating)}</View>
  ...
  return (
    <View style={styles.container}>
      ...
      {/*YOUR RECOMENDATIONS */}
      <View>
        <Text style={styles.booksTitle}>Your Recomentadions </Text>
